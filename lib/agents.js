...
export const AGENTS = [
  ...
  { id: "research", name: "Research Agent", icon: "search",
    role: "Domme, SEC-filings, tidslinje, nøgletal, kildecheck",
    wfId: "", real: false,
    status: "idle", lastRun: null, nextRun: null, successRate: null },
  ...
  { id: "voiceover", name: "Voiceover Agent", icon: "mic",
    role: "ElevenLabs TTS, kapitel-opdelt voiceover",
    wfId: "LvTDjTb8MxEeOJM3", real: true,
  ...
  { id: "community", name: "Community Agent", icon: "messageSquare",
    role: "Auto pin-kommentar (ved publicering) + FB engagement-opslag",
    wfId: "2Nzp6u78iyxfPNZw", real: true,
